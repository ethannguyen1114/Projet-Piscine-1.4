...
<html>
    <head>
        <title> Activités sportives: Cours collectifs</title>
        <meta charset = "utf-8">
        <link rel="stylesheet"  href="typeActiviteSportive.css">
    ...
    <body>
        <nav>
            <ul>
                ...
                <li class="deroulant">Votre compte &ensp;
                    <ul class = "sous">
        ...
        <div class="conteneur">
            ...
            <div class="photo">
                <img src="image/c11.jpeg" alt="photo de profil">
            </div>
            ...
            <section>
                <h2> Disponibilité </h2>
                <div class = "contact-flex">
                           <iframe src="https://calendar.google.com/calendar/embed?src=5qffo86mhil3gh1vf4unthuq2s%40group.calendar.google.com&ctz=Europe%2FParis" style="border: 0" width="400" height="300" frameborder="0" scrolling="no"></iframe>    
                </div>
            </section>
        </div>
    </body>
