    ...
    <body>
     ...
     <div id="container">
            ...
            <form action="clientVerif.php" method="POST"> <center>
                <h2>Connexion à votre compte client</h2> </center><br>
                <label><b>ID client</b></label>
                <input type="text" placeholder="Identification de votre compte client" name="emailClient" required><br>
                <label><b>Mot de passe du client</b></label>
                <input type="password" placeholder="Votre mot de passe" name="mdpClient" required>
